...
ORYX.CONFIG.PICTUREIMPORTER =			ORYX.CONFIG.ROOT_PATH + "pictureimporter";
...
ORYX.CONFIG.SHAPEMENU_BUTTONS_PER_LEVEL_RIGHT = 2;
ORYX.CONFIG.SHAPEMENU_BUTTONS_PER_LEVEL_BOTTOM = 1;
