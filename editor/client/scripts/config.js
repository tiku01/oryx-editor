...
ORYX.CONFIG.EAM_SEQUENCE_LAYOUTER =		ORYX.CONFIG.ROOT_PATH + "eamsequencelayouter";
ORYX.CONFIG.EAM_CLUSTER_LAYOUTER =		ORYX.CONFIG.ROOT_PATH + "eamclusterlayouter";
ORYX.CONFIG.EAM_CARTESIAN_LAYOUTER =	ORYX.CONFIG.ROOT_PATH + "eamcartesianlayouter";
...
ORYX.CONFIG.EVENT_SAPEREMOVED =			"shaperemoved";
...
ORYX.CONFIG.EVENT_LAYOUT_TABLE =			"layout.table";
