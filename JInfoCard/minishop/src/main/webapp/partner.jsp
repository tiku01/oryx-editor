          ...
          <div class=shadow>
            <div class=content>
                <div class=text>
                  ...
                  <p align="right"><img src="images/microsoft-logo.png" width="200" height="42" hspace="20"></p>
                          
                  <p><font face="Arial, Helvetica, sans-serif" size="3" color="#000000"><b>Microsoft</b><br />
                    <br />
                    is the worldwide leading manufacturer of PC software. The 
                    enterprise offers a wide spectrum of products and services. 
                    The range of products of Microsoft applies from operating 
                    systems for PCs and networks about server software for client 
                    server surroundings, to application programs and desktop applications 
                    for business and the private user, multimedia applications 
                    up to Internet platforms and developer tools.</font></p>
                  <p>&nbsp;</p>
                  <p align="right"><img src="images/fhg.png"></p>
                  <p><font face="Arial, Helvetica, sans-serif" size="3" color="#000000"><b>Fraunhofer FOKUS</b>
                  <br />
                  Fraunhofer FOKUS supports innovative processes from the original concept
                  to the (pre)product in companies and institutions - amongst others in
                  the fields of telecommunication, automotive engineering, eGovernment
                  and software development. Solutions developed by FOKUS and its partners
                  are tried out, tested and demonstrated in laboratories.
                  <br />
                  <br />
                  With an expertise of more than 20 years, Fraunhofer FOKUS sees itself
                  as a link between university research on the one hand and industry and
                  ...
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p align="left"><font face="Arial, Helvetica, sans-serif" size="3" color="#000000"><b><img src="images/spacer.gif" width="7" height="3"></b></font>
                </div>
            </div>
          </div>
        </div>
